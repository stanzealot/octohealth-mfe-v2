    ...
    plugins: [
      ...
      federation({
        ...
        exposes: {
          ...
          './StageSummaryCards': './src/components/StageSummaryCards/index.tsx',
          './OpportunityCard': './src/components/OpportunityCard/index.tsx',
          './KanbanColumn': './src/components/KanbanColumn/index.tsx',
        },
        remotes: {
