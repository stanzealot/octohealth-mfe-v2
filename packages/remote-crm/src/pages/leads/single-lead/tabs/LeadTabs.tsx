/**
 * LeadTabs — 2-tab animated bar
 *
 * Tabs: Lead Info | Contact Info
 * Animated sliding green underline indicator (same pattern as ContactTabs).
 * Tab content fades in/out with translateY transition.
 */
